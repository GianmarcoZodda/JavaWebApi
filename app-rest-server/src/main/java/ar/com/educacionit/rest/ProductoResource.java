...
import ar.com.educacionit.rest.validator.ValidatorManager;
...
public class ProductoResource {
	...
	public Response findById(@PathParam("id") Long id
		...
		//1- service
		ProductoService productoService = new ProductoServiceImp(); //f5 entro al contructor // ServiceLocator.getService(PepeService.class);//??tph: crear una clase que creer una instancia 
	...
	public Response create(ProductoDTO request) {
		...
		Map<String,String> errores = ValidatorManager.getValidador("Crear_Producto").validate(request);
	...
	public Response actualizar(
		...
		try {
			...
			productoService.update(productoActualizar);		
			return Response.ok()
